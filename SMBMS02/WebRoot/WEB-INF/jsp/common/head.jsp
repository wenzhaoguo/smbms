...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/show">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/show">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/showUserList">用户管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/password">密码修改</a></li>
